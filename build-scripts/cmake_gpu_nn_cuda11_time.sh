...
module load openmpi/4.1.5 boost/1.84.0 eigen/3.3.7 llvm/17.0.1 cuda/11.7.0 cudnn/8.2.2-cuda11.4
...
onnx_dir="cuda11/onnxruntime-linux-x64-gpu-1.17.3"
cuda_dir="/apps/cuda/11.7.0"
