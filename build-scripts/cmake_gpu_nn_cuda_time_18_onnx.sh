...
module load openmpi/4.1.5 boost/1.84.0 eigen/3.3.7 llvm/17.0.1 cuda/12.3.2 cudnn/8.9.7-cuda12
...
onnx_dir="onnxruntime-linux-x64-gpu-1.18.0"
cuda_dir="/apps/cuda/12.3.2"
